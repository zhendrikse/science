...
🔧 [brownian_motion_2d.js](https://github.com/zhendrikse/science/blob/main/thermodynamics/brownian_motion_2d.js) is based on [Three.js](https://threejs.org/) <br/>

<canvas class="applicationCanvas" id="brownianMotion2d" width="500" height="500"></canvas>
<div class="buttonRow">
...
<script type="module" src="brownian_motion_2d.js"></script>
...
🔧 [brownian_motion_3d.js](https://github.com/zhendrikse/science/blob/main/thermodynamics/brownian_motion_3d.js) is based on [Three.js](https://threejs.org/) <br/>
...
<script type="module" src="brownian_motion_3d.js"></script>
