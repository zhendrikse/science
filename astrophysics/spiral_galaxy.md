...
- This [spiral_galaxy.html](https://github.com/zhendrikse/science/blob/main/astrophysics/code/spiral_galaxy.html) page is a port of the original code to Javascript and [Three.js](https://threejs.org/) 
