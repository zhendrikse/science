...
🔧 This [solar_system.html](https://github.com/zhendrikse/science/blob/main/astrophysics/code/solar_system.html) is in JavaScript &amp; [Three.js](https://threejs.org/) <br/>
🧠 [Newton-Raphson method](https://en.wikipedia.org/wiki/Newton%27s_method) for realistic (elliptic) orbit calculations<br/>
