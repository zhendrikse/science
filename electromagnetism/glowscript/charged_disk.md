...
from vpython import canvas, cylinder, pi, cos, sin, color, sphere, vector, norm, mag, arrow, rate
...
def toggle_background():
    animation.background = color.gray(0.075) if scene.background == color.white else color.white
