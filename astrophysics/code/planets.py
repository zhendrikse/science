...
display_range = 22
display_center = vector(-6.5, 3.55, 0)
animation = canvas(width=600, height=450, background=color.gray(0.075), range=display_range, center=display_center, title=title)
sun_textures = [
...
class Mercury(Planet):
    def __init__(self):
        ...
        label(pos=vector(-18, 4, 0), text='Mercury')
        label(pos=vector(-18, 17.5, 0), text='θ = 0°', box=False)
        label(pos=vector(-18, 15.5, 0), text='58d 15.5h', box=False)
        label(pos=vector(-18, 13.5, 0), text='167℃', box=False)
...
class Venus(Planet):
    def __init__(self):
        ...
        label(pos=vector(-6, 4, 0), text='Venus')
        label(pos=vector(-6, 17.5, 0), text='θ = 177.3°', box=False)
        label(pos=vector(-6, 15.5, 0), text='243d 26m', box=False)
        label(pos=vector(-6, 13.5, 0), text='464℃', box=False)
...
class Earth(Planet):
    def __init__(self):
        ...
        label(pos=vector(6, 4, 0), text='Earth')
        label(pos=vector(6, 17.5, 0), text='θ = 23.4°', box=False)
        label(pos=vector(6, 15.5, 0), text='23h 56m', box=False)
        label(pos=vector(6, 13.5, 0), text='15℃', box=False)
...
class Mars(Planet):
    def __init__(self):
        ...
        self._sphere.opacity = 0.7
        self._sphere.emissive = True
        label(pos=vector(18, 4, 0), text='Mars')
        label(pos=vector(18, 17.5, 0), text='θ = 25.2°', box=False)
        label(pos=vector(18, 15.5, 0), text='1d 36m', box=False)
        label(pos=vector(18, 13.5, 0), text='-65℃', box=False)
...
class Jupiter(Planet):
    def __init__(self):
        ...
        Planet.__init__(self, vector(-18, -10, 0), textures_, 0.0541)
        self._sphere.opacity = 0.7
        self._sphere.emissive = True
        label(pos=vector(-19, -15.5, 0), text='Jupiter')
        label(pos=vector(-19, -1, 0), text='θ = 3.1°', box=False)
        label(pos=vector(-19, -3, 0), text='9h 55m', box=False)
        label(pos=vector(-19, -5, 0), text='-110℃', box=False)
...
class Saturn(Planet):
    def __init__(self):
        ...
        Planet.__init__(self, vector(-6, -10, 0), textures_, 0.0640)
        self._sphere.opacity = 0.7
        self._sphere.emissive = True
        label(pos=vector(-6, -15.5, 0), text='Saturn')
        label(pos=vector(-6, -1, 0), text='θ = 26.7°', box=False)
        label(pos=vector(-6, -3, 0), text='10h 40m', box=False)
        label(pos=vector(-6, -5, 0), text='-140℃', box=False)
        saturn_ring_1 = ring(pos=vector(-6, -10, 0), axis=vector(2, -3, 0), radius=6, thickness=0.09,
                             texture="https://upload.wikimedia.org/wikipedia/commons/b/b4/Saturn_%28planet%29_large.jpg")
        saturn_ring_2 = ring(pos=vector(-6, -10, 0), axis=vector(2, -3, 0), radius=6.5, thickness=0.07,
                             texture="https://upload.wikimedia.org/wikipedia/commons/b/b4/Saturn_%28planet%29_large.jpg")
        saturn_ring_3 = ring(pos=vector(-6, -10, 0), axis=vector(2, -3, 0), radius=5.5, thickness=0.07,
                             texture="https://upload.wikimedia.org/wikipedia/commons/b/b4/Saturn_%28planet%29_large.jpg")
...
class Uranus(Planet):
    def __init__(self):
        ...
        Planet.__init__(self, vector(6, -10, 0), textures_, 0.0750)
        label(pos=vector(6, -15.5, 0), text='Uranus')
        label(pos=vector(6, -1, 0), text='θ = 97.8°', box=False)
        label(pos=vector(6, -3, 0), text='17h 14m', box=False)
        label(pos=vector(6, -5, 0), text='-195℃', box=False)
...
class Neptune(Planet):
    def __init__(self):
        ...
        Planet.__init__(self, vector(18, -10, 0), textures_, 0.0490)
        self._sphere.opacity = 0.7
        self._sphere.emissive = True
        label(pos=vector(18, -15.5, 0), text='Neptune')
        label(pos=vector(18, -1, 0), text='θ = 28.3°', box=False)
        label(pos=vector(18, -3, 0), text='16h', box=False)
        label(pos=vector(18, -5, 0), text='-200℃', box=False)
...
def on_reset():
    animation.center = display_center
    animation.range = display_range
