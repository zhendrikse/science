...
<div id="simContainer">
  <div style="aspect-ratio: 1/1; width:400px;">
    <canvas id="vCanvas" width="400" height="400" style="z-index:1; margin: auto;">Canvas not supported!</canvas>
    <canvas id="theCanvas" width="400" height="400" style="z-index:0; margin: auto;">Canvas not supported!</canvas>
  </div>
</div>
