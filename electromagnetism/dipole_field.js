...
import { ThreeSim, VectorField, ArrowField, Sphere, Body, Range, Particle } from "../js/threesim.js";
...
simulation.attach(dipole.positive.to(new Sphere({
        radius: .1e-14,
        color: new Color("red")
    }))
);

simulation.attach(dipole.negative.to(new Sphere({
        radius: 1e-14 * 0.05,
