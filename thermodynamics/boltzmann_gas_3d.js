...
import { Gas3D, Gas, Aquarium } from '../js/three-js-extensions.js';
...
camera.position.set(230, 125, 560);
camera.lookAt(0, 0, 0);
...
light.position.set(0, 1.5 * boxSize, 0);
scene.add(light);
...
document.getElementById("add3d").addEventListener("click", () => gas.addParticles(50));
